...
if (ctaForm) {
    ...
    ctaForm.addEventListener('submit', function (e) {
        ...
        formData.append('whatsapp', prefixCta + (phone ? phone.value.trim() : ''));
...
if (contactForm) {
    ...
    contactForm.addEventListener('submit', function (e) {
        ...
        formData.append('name', fullNameEl ? fullNameEl.value.trim() : '');
        formData.append('email', emailEl ? emailEl.value.trim() : '');
        formData.append('whatsapp', prefixContact + (wp ? wp.value.trim() : ''));
        formData.append('subject', subjectEl ? subjectEl.value.trim() : '');
        formData.append('indexing', indexing.join(', '));
...
(function () {
    ...
    if (popupForm) {
        ...
        popupForm.addEventListener('submit', function (e) {
            ...
            const pEmail = document.getElementById('popupEmail');
            const pSubject = document.getElementById('popupSubject');
            formData.append('name', pName ? pName.value.trim() : '');
            formData.append('email', pEmail ? pEmail.value.trim() : '');
            formData.append('whatsapp', prefixPopup + (ph ? ph.value.trim() : ''));
            formData.append('subject', pSubject ? pSubject.value.trim() : '');
            formData.append('indexing', indexing.join(', '));
